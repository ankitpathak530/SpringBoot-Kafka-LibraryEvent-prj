package com.kafka.inte.consumer;
...
public class LibraryEventsConsumerIntegrationTest {
    ...
    @Test
    void publishUpdateLibraryEvent1() throws JsonProcessingException, ExecutionException, InterruptedException {
        //given
    ...
    @Test
    void publishUpdateLibraryEvent1_handle_nullValue() throws JsonProcessingException, ExecutionException, InterruptedException {
        ...
        verify(libraryEventsServiceSpy, times(10)).processLibrary(isA(ConsumerRecord.class));
    }
